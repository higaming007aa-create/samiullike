...
def get_player_outfit_info(uid, region):
    ...
    try:
        ...
        url = f"{EMON_API_BASE}/info?uid={uid}&region={region}"
        ...
        print(f"Outfit API error: {e}")
        return None


def get_player_outfit_image(uid, region):
    """Fetch player outfit image from EMON AXC API"""
    try:
        url = f"{EMON_API_BASE}/outfit?uid={uid}&region={region}"
        resp = requests.get(url, timeout=15)
        if resp.status_code == 200:
            return url  # Return the URL for direct image display
        return None
    except:
        return None
        ...
        <div class="main-card">
            ...
            <div class="player-info-card" id="playerInfoCard">
                ...
                <div class="outfit-section" id="outfitSection">
                    <div class="outfit-title">👗 Player Outfit</div>
    ...
    <script>
        ...
        function displayPlayerInfo(data) {
            ...
            if (data.outfit_image_url) {
                ...
                imgContainer.innerHTML = '<div class="outfit-image-placeholder">👕 No outfit image available</div>';
            }
        ...
        async function sendLike() {
            ...
            try {
                ...
                // Display player info with outfit
                displayPlayerInfo({
                ...
                // Display like results
                displayLikeResult(data);
...
def handle_requests():
    ...
    try:
        ...
        # Fetch outfit info from EMON AXC API
